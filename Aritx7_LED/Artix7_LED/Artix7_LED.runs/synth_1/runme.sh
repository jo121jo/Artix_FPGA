...
HD_PWD='C:/Users/joshu/OneDrive/Documents/FPGA_Projects/Artix_FPGA/Aritx7_LED/Artix7_LED/Artix7_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log A7_LED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source A7_LED.tcl
