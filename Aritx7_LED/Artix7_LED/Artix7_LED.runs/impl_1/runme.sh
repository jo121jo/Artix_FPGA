...
HD_PWD='C:/Users/joshu/OneDrive/Documents/FPGA_Projects/Artix_FPGA/Aritx7_LED/Artix7_LED/Artix7_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log A7_LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source A7_LED.tcl -notrace
